...
<link rel="stylesheet" href="/admin-assets/admin.css?v=20260923-v24-9">
</head>
<body>
...
<aside class="sidebar hidden" id="admin-sidebar">
    ...
    <nav class="admin-nav">
        ...
        <div class="casino-nav-group collapsed"><button class="nav-item casino-nav-parent" type="button" data-page="casino" aria-expanded="false" aria-controls="casino-admin-submenu"><span>♠</span> Jogos <svg class="casino-nav-chevron" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></button><div class="casino-subnav" id="casino-admin-submenu"><button type="button" class="casino-subitem" data-casino-tab="games">♧ Catálogo de jogos</button><button type="button" class="casino-subitem" data-casino-tab="categories">◈ Categorias</button><button type="button" class="casino-subitem" data-casino-tab="credentials">⚿ Credenciais das APIs</button><button type="button" class="casino-subitem" data-casino-tab="bets" disabled title="Depende de integração real">◴ Histórico de apostas <small>Em preparação</small></button><button type="button" class="casino-subitem" data-casino-tab="providers">▣ Provedores</button><button type="button" class="casino-subitem" data-casino-tab="rtp" disabled title="Depende de apostas liquidadas">▥ RTP observado <small>Em preparação</small></button></div></div>
        <button class="nav-item" data-page="audit"><span>▤</span> Logs / Auditoria</button>
        <div class="notification-admin-group collapsed"><button class="nav-item notification-admin-parent" type="button" data-page="notifications" aria-expanded="false" aria-controls="notification-admin-submenu"><span class="nav-bell-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9"/><path d="M10 21h4"/></svg></span> Notificações <svg class="casino-nav-chevron" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></button><div class="notification-admin-subnav" id="notification-admin-submenu"><button type="button" class="notification-admin-subitem" data-admin-notification-tab="central">⌂ Central de Notificações</button><button type="button" class="notification-admin-subitem" data-admin-notification-tab="manual">✎ Mensagens manuais</button><button type="button" class="notification-admin-subitem" data-admin-notification-tab="automations">⚙ Notificações automáticas</button></div></div>
        <div class="promotion-admin-group collapsed"><button class="nav-item promotion-admin-parent" type="button" data-page="promotions" aria-expanded="false" aria-controls="promotion-admin-submenu"><span>◆</span> Promoções <svg class="casino-nav-chevron" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></button><div class="promotion-admin-subnav" id="promotion-admin-submenu"><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="central">⌂ Central de Promoções</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="agency">♧ Agência</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="chests">⬡ Baús e indicações</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="checkin">▦ Check-in diário</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="coupons">▣ Cupons</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="envelope">✉ Envelope vermelho</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="rescue">▤ Fundos de Resgate</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="roulette">◌ Giro da Sorte</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="bonus-history">♙ Histórico de bônus</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="level-history">☷ Histórico de níveis</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="vip">♛ Níveis VIP</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="rebate">↺ Rebate</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="cashwheel">◉ Roleta de Saque</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="lottery">✧ Sorteio</button></div></div>
        <button class="nav-item" data-page="support"><span>☏</span> Suporte</button>
...
<section id="admin-app" class="hidden">
    <header class="admin-topbar">
        ...
        <div class="admin-topbar-actions"><a class="visit-site" href="/" target="_blank" rel="noopener noreferrer">Ver site ↗</a><div class="admin-profile"><span class="admin-profile-avatar">A</span><span class="admin-profile-text"><strong id="admin-name"></strong><button id="admin-logout" class="admin-profile-logout hidden" type="button">Sair</button></span></div></div>
    </header>
    ...
    <section id="page-casino" class="admin-page hidden">
      ...
      <div class="dashboard-actions"><span>Catálogo, abertura de jogos e callbacks das APIs integrados ao ledger.</span><button id="casino-refresh" class="secondary-action">Atualizar</button></div>
      ...
      <article class="panel casino-panel hidden" id="casino-credentials-panel"><div class="panel-title"><h2>APIs de Jogos · Integrações</h2><span>As credenciais ficam criptografadas. Apenas uma API de jogos pode permanecer ativa por vez.</span></div>
      <div class="casino-api-exclusive-note">Ao ativar uma integração, a outra será desativada automaticamente sem apagar suas credenciais ou catálogo.</div>
      <div class="casino-api-card"><h3>PlayFiver</h3><div id="playfiver-alert" class="alert hidden"></div>
      ...
      <div class="casino-api-card"><h3>Games2API</h3><div id="games2api-alert" class="alert hidden"></div><p id="games2api-status">Carregando configuração...</p>
      <form id="games2api-form" class="casino-form" autocomplete="off"><label>URL da API<input name="base_url" type="url" required value="https://api.games2api.xyz"></label><label>Agent Code<input name="agent_code" maxlength="1024" autocomplete="off" placeholder="Em branco: preservar credencial salva"></label><label>Agent Token<input name="agent_token" type="password" maxlength="1024" autocomplete="new-password" placeholder="Em branco: preservar credencial salva"></label><label>Agent Secret<input name="agent_secret" type="password" maxlength="1024" autocomplete="new-password" placeholder="Em branco: preservar credencial salva"></label><label class="casino-check"><input name="enabled" type="checkbox"> Ativar integração Games2API</label><div class="games-api-title-actions"><button type="submit" class="gold-button casino-save">SALVAR INTEGRAÇÃO</button><button type="button" class="secondary-action" id="games2api-sync">SINCRONIZAR CATÁLOGO</button></div></form>
      <div class="playfiver-callback-box"><strong>Callback Games2API</strong><code id="games2api-callback-url">/api/webhooks/casino/games2api</code><small>Cadastre esta URL HTTPS no painel Games2API. O callback valida Agent Code + Agent Secret.</small></div></div>
      </article>
      <article class="panel casino-panel games-api-panel" id="casino-games-panel">
        <div class="panel-title games-api-title"><div><h2>Gerenciamento de Jogos API</h2><span>Catálogos PlayFiver/Games2API + jogos manuais. As logos dos provedores continuam cadastradas manualmente.</span></div><div class="games-api-title-actions"><button type="button" class="gold-button" id="new-game">＋ Adicionar Jogo</button></div></div><div class="casino-sync-status">PlayFiver permanece local/versionado; Games2API pode ser sincronizada pelo painel. Apenas a API ativa aparece ao jogador.</div>
        ...
        <div class="games-api-info"><strong>ⓘ Informações</strong><div><span>Os catálogos de cada API permanecem separados no banco e são preservados ao alternar a integração ativa.</span><span>Use a busca para localizar jogos rapidamente.</span><span>Marque como Popular para destacar na home.</span><span>Desativar o status oculta o jogo do catálogo público.</span></div></div>
      </article>
    </section>
...
<section id="page-settings" class="admin-page hidden"><article class="panel"><div class="panel-title"><h2>Configurações gerais</h2><span>Identidade, disponibilidade e regras comerciais da plataforma.</span></div><div id="settings-alert" class="alert hidden"></div><form id="settings-form" class="platform-form"><label>Nome do site<input name="site_name" maxlength="120" required></label><label>E-mail de suporte<input name="support_email" type="email"></label><label>Cor principal<input name="accent_color" type="color"></label><label class="checkline"><input name="maintenance" type="checkbox"> Ativar modo manutenção (site público indisponível)</label><div class="settings-subsection"><div><h3>Depósitos e bônus de primeiro depósito</h3><p class="hint">Configure os valores rápidos exibidos ao jogador e a oferta do primeiro depósito. O bônus é creditado no saldo disponível somente após a confirmação do primeiro depósito pago.</p></div><label>Valores rápidos de depósito (R$)<input name="deposit_presets" maxlength="120" placeholder="10, 30, 50, 100"><small>Separe por vírgula. Ex.: 10, 30, 50, 100.</small></label><label class="checkline"><input name="first_deposit_bonus_enabled" type="checkbox"> Ativar bônus de primeiro depósito</label><div class="settings-deposit-grid"><label>Depósito mínimo para bônus (R$)<input name="first_deposit_bonus_min_brl" type="number" min="1" step="0.01" placeholder="30.00"></label><label>Percentual do bônus (%)<input name="first_deposit_bonus_percent" type="number" min="1" max="500" step="0.01" placeholder="100"></label><label>Limite máximo do bônus (R$)<input name="first_deposit_bonus_max_brl" type="number" min="0" step="0.01" placeholder="0"><small>Use 0 para não limitar.</small></label></div></div><button type="submit" class="gold-button">Salvar configurações</button></form></article></section>
...
<div class="appearance-content hidden" data-appearance-panel="floats"><article class="panel appearance-panel"><div class="panel-title"><div><h2>Ícones flutuantes</h2><span>Crie atalhos promocionais com PNG, JPG, WebP ou GIF animado.</span></div><button type="button" id="new-floating-icon" class="gold-button">+ Novo ícone</button></div><p class="hint">Associe o ícone a um módulo para abrir a promoção diretamente e, se quiser, exiba-o somente quando o jogador tiver benefício disponível.</p><div id="floating-icons-alert" class="alert hidden"></div><div id="floating-icons-list" class="platform-list appearance-banner-list"></div></article></div>
...
<article class="panel mz-admin-promo-overview mz-promo-central-panel" id="mz-promo-oversight">
  ...
  <details class="mz-admin-promo-details" open><summary>Controles rápidos de campanhas</summary><p class="hint">Ative ou desative uma configuração sem alterar seus valores históricos.</p><div class="table-wrap"><table><thead><tr><th>Módulo</th><th>Campanha</th><th>Status</th><th>Ação</th></tr></thead><tbody id="mz-oversight-configs"></tbody></table></div></details>
  <section class="mz-player-diagnostic"><div><h3>Diagnóstico por jogador</h3><p class="hint">Informe o ID público ou UUID para consultar por que existem ou não benefícios disponíveis.</p></div><form id="mz-player-diagnostic-form"><input id="mz-player-diagnostic-input" placeholder="Ex.: 1024 ou UUID" autocomplete="off"><button type="submit" class="secondary">CONSULTAR</button></form><div id="mz-player-diagnostic-result"></div></section>
</article>
<article class="panel mz-admin-promo-audit mz-promo-central-panel" id="mz-promo-financial-audit">
...
<section id="page-notifications" class="admin-page hidden">
  <article class="panel notification-admin-central" data-notification-panel="central">
    <div class="panel-title"><div><h2>Central de Notificações</h2><span>Visão rápida das mensagens e automações da plataforma.</span></div></div>
    <div class="notification-summary-grid"><article><span>Mensagens cadastradas</span><strong id="notification-summary-total">—</strong></article><article><span>Publicadas</span><strong id="notification-summary-active">—</strong></article><article><span>Automações ativas</span><strong id="notification-summary-auto">—</strong></article><article><span>Alta/Urgente</span><strong id="notification-summary-priority">—</strong></article></div>
    <p class="hint">Use os submenus para editar mensagens manuais ou as regras automáticas por evento.</p>
  </article>
  <article class="panel notification-admin-compose hidden" data-notification-panel="manual">
    <div class="panel-title"><div><h2>Notificações da plataforma</h2><span>Anúncios, financeiro, promoções, segurança, sistema, usuário e suporte.</span></div></div>
    <div id="notifications-alert" class="alert hidden"></div>
    <form id="notification-form" class="notification-admin-form">
      <input type="hidden" name="id">
      <label>Categoria<select name="category" required><option value="announcement">Anúncios</option><option value="financial">Financeiro</option><option value="promotion">Promoções</option><option value="security">Segurança</option><option value="support">Suporte</option><option value="system">Sistema</option><option value="user">Usuário</option></select></label><label>Prioridade<select name="priority" required><option value="normal">Normal</option><option value="high">Alta</option><option value="urgent">Urgente</option></select></label>
      <label>Público<select name="audience" required><option value="ALL">Todos os jogadores</option><option value="USER">Usuário específico</option></select></label>
      <label class="notification-user-target hidden">Jogador<input name="user_identifier" placeholder="ID público, UUID, usuário ou e-mail"></label>
      <label>Título<input name="title" maxlength="120" required placeholder="Título da notificação"></label>
      <label class="notification-message-field">Mensagem<textarea name="message" maxlength="1000" rows="4" required placeholder="Mensagem exibida ao jogador"></textarea></label>
      <label>Link interno opcional<input name="link_path" maxlength="255" placeholder="/promocoes"></label>
      <label>Início<input name="starts_at" type="datetime-local"></label>
      <label>Fim<input name="ends_at" type="datetime-local"></label>
      <label class="checkline"><input name="enabled" type="checkbox" checked> Publicar notificação</label>
      <div class="notification-admin-actions"><button type="submit" class="gold-button">Salvar notificação</button><button type="button" id="notification-form-reset" class="secondary">Limpar</button></div>
    </form>
  </article>
  <article class="panel hidden" data-notification-panel="manual">
    <div class="panel-title"><div><h2>Mensagens cadastradas</h2><span>As notificações individuais também ficam registradas para auditoria.</span></div><button type="button" id="notifications-refresh" class="secondary">Atualizar</button></div>
    <div class="table-wrap"><table><thead><tr><th>Categoria</th><th>Prioridade</th><th>Público</th><th>Título</th><th>Status</th><th>Período</th><th>Ações</th></tr></thead><tbody id="notifications-body"></tbody></table></div>
  </article>
  <article class="panel notification-automation-panel hidden" data-notification-panel="automations">
    <div class="panel-title"><div><h2>Notificações automáticas</h2><span>Ative ou desative eventos e personalize o texto enviado automaticamente ao jogador.</span></div><button type="button" id="notification-automations-refresh" class="secondary">Atualizar</button></div>
    <div id="notification-automations-alert" class="alert hidden"></div>
    <form id="notification-automation-form" class="notification-admin-form hidden">
      <input type="hidden" name="event_key">
      <label>Evento<input name="event_label" readonly></label>
      <label>Categoria<select name="category" required><option value="financial">Financeiro</option><option value="promotion">Promoções</option><option value="security">Segurança</option><option value="system">Sistema</option><option value="user">Usuário</option></select></label>
      <label>Prioridade<select name="priority" required><option value="normal">Normal</option><option value="high">Alta</option><option value="urgent">Urgente</option></select></label>
      <label>Título<input name="title_template" maxlength="120" required></label>
      <label class="notification-message-field">Mensagem<textarea name="message_template" maxlength="1000" rows="3" required></textarea></label>
      <label>Link interno<input name="link_path" maxlength="255" placeholder="/carteira"></label>
      <label class="checkline"><input name="enabled" type="checkbox"> Automação ativa</label>
      <div class="notification-admin-actions"><button type="submit" class="gold-button">Salvar automação</button><button type="button" id="notification-automation-cancel" class="secondary">Cancelar</button></div>
      <p class="hint notification-message-field">Variáveis disponíveis: <code>{amount}</code> para valores e <code>{count}</code> para quantidades, conforme o evento.</p>
    </form>
    <div class="table-wrap"><table><thead><tr><th>Evento</th><th>Categoria</th><th>Prioridade</th><th>Status</th><th>Título</th><th>Ação</th></tr></thead><tbody id="notification-automations-body"></tbody></table></div>
  </article>
</section>
<section id="page-support" class="admin-page hidden">
  <div id="support-admin-alert" class="alert hidden"></div>
  <article class="panel support-admin-queue">
    <div class="panel-title"><div><h2>Central de Suporte</h2><span>Tickets, prioridade, SLA e histórico de atendimento.</span></div><button type="button" id="support-admin-refresh" class="secondary">Atualizar</button></div>
    <div class="support-admin-toolbar"><input id="support-admin-search" type="search" placeholder="Buscar ticket, usuário, e-mail ou ID"><select id="support-admin-status"><option value="">Todos os status</option><option value="OPEN">Abertos</option><option value="IN_PROGRESS">Em atendimento</option><option value="RESOLVED">Resolvidos</option><option value="CLOSED">Fechados</option></select><select id="support-admin-category"><option value="">Todas as categorias</option><option value="deposit">Depósito</option><option value="withdrawal">Saque</option><option value="bonus">Bônus</option><option value="account">Conta</option><option value="games">Jogos</option><option value="other">Outros</option></select><button type="button" id="support-admin-search-btn" class="secondary">Buscar</button></div>
    <div class="table-wrap"><table><thead><tr><th>Ticket</th><th>Jogador</th><th>Categoria</th><th>Prioridade</th><th>Status</th><th>SLA</th><th>Atualizado</th><th></th></tr></thead><tbody id="support-admin-body"></tbody></table></div>
  </article>
  <article id="support-admin-detail" class="panel support-admin-detail hidden">
    <div class="panel-title"><div><h2 id="support-admin-detail-title">Atendimento</h2><span id="support-admin-detail-meta"></span></div><button type="button" id="support-admin-detail-close" class="secondary">Fechar detalhe</button></div>
    <div class="support-admin-controls"><label>Status<select id="support-admin-detail-status"><option value="OPEN">Aberto</option><option value="IN_PROGRESS">Em atendimento</option><option value="RESOLVED">Resolvido</option><option value="CLOSED">Fechado</option></select></label><label>Prioridade<select id="support-admin-detail-priority"><option value="normal">Normal</option><option value="high">Alta</option><option value="urgent">Urgente</option></select></label><button type="button" id="support-admin-update" class="secondary">Salvar situação</button></div>
    <div id="support-admin-messages" class="support-message-list"></div>
    <form id="support-admin-reply-form" class="support-reply-form"><input type="hidden" name="ticket_id"><textarea name="message" rows="4" maxlength="3000" required placeholder="Escreva a resposta ao jogador"></textarea><label>Anexo opcional<input name="image" type="file" accept="image/png,image/jpeg,image/webp"></label><label class="checkline"><input type="checkbox" name="internal"> Observação interna (não aparece ao jogador)</label><div><button type="submit" class="gold-button">Enviar resposta</button></div></form>
  </article>
</section>
...
<div class="abilitypay-fields hidden"><h3>Credenciais AbilityPay</h3><div class="grid two"><label>Client ID<input name="abilitypay_client_id" autocomplete="off" placeholder="deixe vazio para manter"></label><label>Client Secret<input name="abilitypay_client_secret" type="password" autocomplete="new-password" placeholder="deixe vazio para manter"></label></div><div class="grid two"><label>Base URL<input name="abilitypay_base_url" value="https://abilitypay.app/api"></label><label>Callback configurado na AbilityPay<input name="abilitypay_callback_url" readonly placeholder="https://seusite.com/api/abilitypay/callback"></label></div><div class="grid two"><label>Descrição do depósito<input name="abilitypay_deposit_description" maxlength="120" value="Depósito PIX"></label><label>Descrição do saque<input name="abilitypay_withdrawal_description" maxlength="120" value="Saque da plataforma"></label></div><p class="hint">Cadastre no painel AbilityPay o callback HTTPS <code>/api/abilitypay/callback</code>. O Client Secret fica criptografado e nunca volta ao navegador.</p></div>
<div class="bspay-fields hidden"><h3>Credenciais BSPAY</h3><div class="grid two"><label>Client ID<input name="bspay_client_id" autocomplete="off" placeholder="deixe vazio para manter"></label><label>Client Secret<input name="bspay_client_secret" type="password" autocomplete="new-password" placeholder="deixe vazio para manter"></label></div><div class="grid two"><label>Signing Key<input name="bspay_signing_key" type="password" autocomplete="new-password" placeholder="obrigatória para saques"></label><label>Base URL<input name="bspay_base_url" value="https://api.bspay.co"></label></div><label>Postback URL BSPAY (opcional)<input name="bspay_webhook_url" placeholder="https://seudominio.com/api/bspay/callback"></label><label>Callback sugerido<input name="bspay_callback_url" readonly placeholder="https://seusite.com/api/bspay/callback"></label><label>Descrição do saque<input name="bspay_withdrawal_description" maxlength="120" value="Saque da plataforma"></label><p class="hint">A BSPAY usa OAuth2 com Client ID/Client Secret. Saques exigem a Signing Key. Se o Postback URL ficar vazio, a BSPAY usará o postback padrão configurado na própria credencial. Se preencher, use uma URL HTTPS pública e resolvível.</p></div>
...
<div class="admin-editor-overlay hidden" id="editor-floating-icons-form" role="dialog" aria-modal="true" aria-label="Editar ícone flutuante"><div class="admin-editor-card"><header class="admin-editor-head"><h2 id="editor-title-floating-icons-form">Novo ícone flutuante</h2><button type="button" class="admin-editor-close" aria-label="Fechar">×</button></header><div class="admin-editor-error alert hidden" role="alert"></div><form id="floating-icons-form" class="platform-form appearance-edit-form admin-modal-form"><input type="hidden" name="id"><label>Título<input name="title" maxlength="120" required placeholder="Ex.: Central de Recompensas"></label><label>Imagem / GIF<input type="file" name="image" accept="image/png,image/jpeg,image/webp,image/gif"><small>Recomendado: arquivo quadrado, 128 × 128 px ou maior. GIF animado é aceito. Máximo 5 MB.</small></label><input type="hidden" name="image_path"><label>Link opcional<input name="link_path" maxlength="500" placeholder="/promocoes ou https://..."></label><label>Módulo associado<select name="module_id"><option value="">Nenhum</option><option value="rewards_center">Central de Recompensas</option><option value="agency">Agência e Indicações</option><option value="chests">Baú do Tesouro</option><option value="checkin">Check-in</option><option value="vip">Clube VIP</option><option value="rescue">Fundos de Resgate</option><option value="roulette">Giro da Sorte</option><option value="cashwheel">Roleta de Saque</option><option value="lottery">Sorteio de Cartas</option><option value="coupons">Troca de Recompensas</option><option value="rebate">Rebate</option></select></label><label>Quando exibir<select name="show_when"><option value="always">Sempre que estiver ativo</option><option value="any_reward">Quando houver qualquer recompensa disponível</option><option value="module_available">Quando o módulo associado estiver disponível</option></select></label><label>Ordem<input name="sort_order" type="number" min="0" max="100000" value="100" required></label><label class="checkline"><input name="enabled" type="checkbox" checked> Exibir ícone</label><button class="gold-button" type="submit">Salvar ícone</button><button type="button" class="secondary modal-cancel">Cancelar</button></form></div></div>
...
<script src="/admin-assets/admin.js?v=20260923-v24-10"></script>
