...
<link rel="stylesheet" href="/admin-assets/admin.css?v=20260923-v24-6">
</head>
<body>
...
<aside class="sidebar hidden" id="admin-sidebar">
    ...
    <nav class="admin-nav">
        ...
        <button class="nav-item" data-page="notifications"><span class="nav-bell-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9"/><path d="M10 21h4"/></svg></span> Notificações</button>
...
<section id="page-notifications" class="admin-page hidden">
  <article class="panel notification-admin-compose">
  ...
  <article class="panel notification-automation-panel">
...
<script src="/admin-assets/admin.js?v=20260923-v24-6"></script>
