...
<link rel="stylesheet" href="/admin-assets/admin.css?v=20260922-mobile-fixes-v21-3">
</head>
<body>
<div class="admin-shell login-mode" id="admin-shell">
<aside class="sidebar hidden" id="admin-sidebar">
    <div class="admin-brand"><img id="admin-site-logo" class="admin-site-logo hidden" alt="<?=ah($siteName)?>"><b id="admin-brand-fallback">M</b><span><strong id="admin-brand-name"><?=ah($siteName)?></strong><small>ADMIN</small></span></div>
    <nav class="admin-nav">
...
<script src="/admin-assets/admin.js?v=20260922-envelope-weekly-v20-2"></script>
