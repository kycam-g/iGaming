...
<link rel="stylesheet" href="/admin-assets/admin.css?v=20260917-v12-11-playfiver-catalog">
</head>
<body>
...
<section id="admin-app" class="hidden">
    ...
    <section id="page-casino" class="admin-page hidden">
      ...
      <article class="panel casino-panel games-api-panel" id="casino-games-panel">
        <div class="panel-title games-api-title"><div><h2>Gerenciamento de Jogos API</h2><span>Visualize e gerencie os jogos cadastrados por provedor e API.</span></div><div class="games-api-title-actions"><button type="button" class="secondary-action" id="sync-playfiver">↻ Sincronizar PlayFiver</button><button type="button" class="gold-button" id="new-game">＋ Adicionar Jogo</button></div></div><div id="playfiver-sync-status" class="casino-sync-status">Importa todos os provedores e jogos publicados pela API. Logos cadastradas manualmente são preservadas.</div>
        ...
        <div class="table-wrap games-api-table-wrap"><table class="games-api-table"><thead><tr><th>Banner</th><th>Nome</th><th>Código</th><th>Provider</th><th>API</th><th>Total de acessos</th><th>Status</th><th>Popular</th><th>Ações</th></tr></thead><tbody id="casino-games-body"></tbody></table></div>
        ...
        <div class="games-api-info"><strong>ⓘ Informações</strong><div><span>Use “Sincronizar PlayFiver” para importar ou atualizar o catálogo completo publicado pela API.</span><span>Use a busca para localizar jogos rapidamente.</span><span>Marque como Popular para destacar na home.</span><span>Desativar o status oculta o jogo do catálogo público.</span></div></div>
      </article>
    </section>
...
<script src="/admin-assets/admin.js?v=20260917-v12-11-playfiver-catalog"></script>
