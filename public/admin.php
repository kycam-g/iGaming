...
<link rel="stylesheet" href="/admin-assets/admin.css?v=20260922-modulos-v7">
</head>
<body>
...
<aside class="sidebar hidden" id="admin-sidebar">
    ...
    <nav class="admin-nav">
        ...
        <div class="promotion-admin-group collapsed"><button class="nav-item promotion-admin-parent" type="button" data-page="promotions" aria-expanded="false" aria-controls="promotion-admin-submenu"><span>◆</span> Promoções <svg class="casino-nav-chevron" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></button><div class="promotion-admin-subnav" id="promotion-admin-submenu"><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="vip">♛ Níveis VIP</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="coupons">▣ Cupons</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="checkin">▦ Check-in diário</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="roulette">◌ Roleta de boas-vindas</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="envelope">✉ Envelope vermelho</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="chests">⬡ Baús e indicações</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="agency">♧ Agência</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="rebate">↺ Rebate</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="rescue">▤ Fundos de Resgate</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="weekly">▦ Compensação Semanal</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="cashwheel">◉ Roleta de Saque</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="lottery">✧ Sorteio</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="bonus-history">♙ Histórico de bônus</button><button type="button" class="promotion-admin-subitem" data-admin-promotion-tab="level-history">☷ Histórico de níveis</button></div></div>
...
<section id="page-promotions" class="admin-page hidden"><article id="admin-promotion-detail" class="panel hidden" aria-live="polite"><div class="promotion-manager-head"><div><h2 id="admin-promotion-detail-title"></h2><p id="admin-promotion-detail-description" class="hint"></p></div><button type="button" id="promotion-config-new" class="gold-button">+ Adicionar novo</button></div><div id="promotion-config-alert" class="alert hidden" role="alert"></div><div class="table-wrap"><table><thead id="promotion-config-head"></thead><tbody id="promotion-config-body"></tbody></table></div><p class="hint promotion-config-note">Configuração administrativa: nenhuma premiação, crédito, cupom ou rodada é concedida automaticamente por esta tela.</p></article><article id="admin-promotion-campaigns" class="panel"><div class="panel-title"><h2>Promoções</h2><span>Somente campanhas e imagens promocionais. Os banners do carrossel e lobby permanecem em Aparência.</span><button type="button" class="gold-button" id="new-promotion">+ Nova promoção</button></div><div id="promotions-alert" class="alert hidden"></div><div id="promotions-list" class="platform-list"></div></article></section>
