...
<link rel="stylesheet" href="/admin-assets/admin.css?v=20260923-v24-3">
</head>
<body>
...
<section id="page-notifications" class="admin-page hidden">
  <article class="panel notification-admin-compose">
    <div class="panel-title"><div><h2>Notificações da plataforma</h2><span>Anúncios, sistema, mensagens individuais e suporte.</span></div></div>
    <div id="notifications-alert" class="alert hidden"></div>
    <form id="notification-form" class="notification-admin-form">
      <input type="hidden" name="id">
      <label>Categoria<select name="category" required><option value="announcement">Anúncios</option><option value="system">Sistema</option><option value="user">Usuário</option><option value="support">Suporte</option></select></label>
  ...
  <article class="panel">
    ...
    <div class="table-wrap"><table><thead><tr><th>Categoria</th><th>Público</th><th>Título</th><th>Status</th><th>Período</th><th>Ações</th></tr></thead><tbody id="notifications-body"></tbody></table></div>
  </article>
</section>
...
<script src="/admin-assets/admin.js?v=20260923-v24-4"></script>
